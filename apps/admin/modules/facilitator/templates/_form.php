    ...
    <div id="loginbox">
        <form action="<?php echo url_for('user/'.($form->getObject()->isNew() ? 'new' : 'edit').(!$form->getObject()->isNew() ? '?id='.$form->getObject()->getId() : '')) ?>" method="post">
            ...
            <ul>
              ...
              <li><div class='form-label'>Initial:</div> <?php echo $form['address'] ?></li>
              <li class="error">&nbsp; <?php echo $form['address']->getError() ?></li>
              <li><div class='form-label'>Initial:</div> <?php echo $form['contact1'] ?></li>
              <li class="error">&nbsp; <?php echo $form['contact1']->getError() ?></li>
              <li><div class='form-label'>Initial:</div> <?php echo $form['contact2'] ?></li>
