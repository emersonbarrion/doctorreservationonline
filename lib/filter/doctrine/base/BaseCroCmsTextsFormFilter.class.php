...
/**
 * CroCmsTexts filter form base class.
 *
 ...
 */
abstract class BaseCroCmsTextsFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('cro_cms_texts_filters[%s]');
