 ...
 * 
 * @method string              getActivationkey() Returns the current record's "activationkey" value
 ...
 * @method CroAdminUsers       setActivationkey() Sets the current record's "activationkey" value
...
abstract class BaseCroAdminUsers extends sfDoctrineRecord
{
    public function setTableDefinition()
    {
        ...
        $this->hasColumn('activationkey', 'string', 32, array(
             'type' => 'string',
             'notnull' => true,
             'length' => 32,
             ));
