...
/**
 * CroCmsTexts form base class.
 *
 * @method CroCmsTexts getObject() Returns the current form's model object
 *
 ...
 */
abstract class BaseCroCmsTextsForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('cro_cms_texts[%s]');
